...
class NanoDetPlusHead(nn.Module):
    ...
    def loss(self, preds, gt_meta, aux_preds=None):
        ...
        print("************dis_preds = self.distribution_project(reg_preds) * center_priors[..., 2, None]**************")
        print(reg_preds.shape) #torch.Size([48, 8500, 32])
        ...
        if aux_preds is not None:
            ...
            print("*************aux_cls_preds, aux_reg_preds = aux_preds.split(*****************")
            print(aux_reg_preds.shape) #
            print("************dis_preds = self.distribution_project(reg_preds) * center_priors[..., 2, None]**************")
            aux_dis_preds = (
