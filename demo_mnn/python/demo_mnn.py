...
def main():
    ...
    parser.add_argument('--model_bin', dest='model_bin', type=str, default='../model/nanodet-320.bin')
    ...
    parser.add_argument('--backend', choices=['MNN', 'ONNX', 'torch', 'ncnn'], default='MNN')
